...
async function main() {
	const steps = [
		{ name: "System Check", script: "install/steps/00_check_system.js" },
		...
		{
			name: "Permissions",
			script: "install/seed/steps/05_permissions.js",
			key: "permissions",
		},
		{
			name: "Admin User",
			script: "install/seed/steps/06_admin_user.js",
			key: "admin_user",
		},
		{
			name: "Permissions",
			script: "install/seed/steps/05_permissions.js",
			key: "permissions",
		}, // repeter esl  ligne deux fois permet de remplir les test en une fois, si l'un arrive
	];
